...
#$ -q 72H
#$ -pe openmpi 128
#$ -hold_jid mfgoc-2p4p4cNoNormNoIP
...
mpirun -np $NSLOTS python ./src/LaunchSearchMPI.py ./config/OnlyGoC/SimulationConfigSearchClusterMFGoC2p4p4cNoNormNoIP.cfg
