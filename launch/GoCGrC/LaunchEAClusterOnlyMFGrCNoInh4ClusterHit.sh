...
#$ -q 72H
#$ -pe openmpi 128
#$ -hold_jid deap-onlymfgrc-noinh-learning
...
mpirun -np $(($NSLOTS+1)) python ./src/LaunchEvolutionaryAlgorithmMPI.py ./config/GoCGrC/EASearchGranularPlastOnlyMFGrCNoInh4ClusterHit.cfg
