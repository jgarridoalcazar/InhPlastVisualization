...
mpirun python ./src/LaunchSimulation.py -c ./config/TestMarconi/AllPlast4Hit1Th100um_mpi.cfg 2> ./results/$PBS_JOBNAME.$PBS_JOBID.txt > ./results/$PBS_JOBNAME.$PBS_JOBID.out
