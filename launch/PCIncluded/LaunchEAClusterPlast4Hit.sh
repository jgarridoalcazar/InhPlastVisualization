...
#$ -q 72H
#$ -pe openmpi 128
#$ -hold_jid deap4-pc-all-learning
...
mpirun-test -np $(($NSLOTS+1)) -ppn 8 python ./src/LaunchEvolutionaryAlgorithmMPI.py ./config/PCIncluded/EASearchGranularPlast4ClusterHit.cfg
