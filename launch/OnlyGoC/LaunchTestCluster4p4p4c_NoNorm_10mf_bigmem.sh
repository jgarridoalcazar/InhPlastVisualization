...
#$ -q 24Hbigmem
#$ -pe openmpi 32
# $ -hold_jid test-4p4p4c-NoNorm-10mf
...
mpirun -np $NSLOTS python ./src/LaunchSearchMPI.py ./config/OnlyGoC/SimulationConfigClusterTest4p4p4c_NoNorm10.cfg
