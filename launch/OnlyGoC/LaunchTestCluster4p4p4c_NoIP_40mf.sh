...
#$ -q 24H
#$ -pe openmpi 32
# $ -hold_jid test-4p4p4c-NoIP-40mf
...
mpirun -np $NSLOTS python ./src/LaunchSearchMPI.py ./config/OnlyGoC/SimulationConfigClusterTest4p4p4c_NoIP40.cfg
