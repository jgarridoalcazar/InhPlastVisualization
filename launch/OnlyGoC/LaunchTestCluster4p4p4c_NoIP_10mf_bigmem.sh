...
#$ -q 24Hbigmem
#$ -pe openmpi 64
# $ -hold_jid test-4p4p4c-NoIP-10mf
...
mpirun -np $NSLOTS python ./src/LaunchSearchMPI.py ./config/OnlyGoC/SimulationConfigClusterTest4p4p4c_NoIP10.cfg
