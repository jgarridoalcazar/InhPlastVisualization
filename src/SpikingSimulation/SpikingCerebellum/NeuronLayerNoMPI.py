...
class NeuronLayer(InputLayer.InputLayer):
    ...
    template_model_parameters = {
                         ...
                         'ConductanceLIFwIP': ['cm','texc','tinh','grest','eexc','einh','erest','eth','tref', 'tau_ip','beta_ip','epsilon_rc_ip','epsilon_rr_ip','tau_minus', 'tau_istdp'],
                         'ConductanceLIFwIPSym': ['cm','texc','tinh','grest','eexc','einh','erest','eth','tref', 'tau_ip','beta_ip','epsilon_rc_ip','epsilon_rr_ip','tau_sym','tau_minus', 'max_cm'],
