...
namespace mynest
{
  ...
  ESTDPHomCommonProperties::ESTDPHomCommonProperties() :
  ...
  void ESTDPHomCommonProperties::get_status(DictionaryDatum & d) const
  {
  ...
  void ESTDPHomCommonProperties::set_status(const DictionaryDatum & d, nest::ConnectorModel &cm)
  {
  ...
  ESTDPConnectionHom::ESTDPConnectionHom() :
    Kplus_(0.0)
  { }

  ESTDPConnectionHom::ESTDPConnectionHom(const ESTDPConnectionHom &rhs) :
    ConnectionHetWD(rhs)
  {
    Kplus_ = rhs.Kplus_;
  }

  void ESTDPConnectionHom::get_status(DictionaryDatum & d) const
  {
  ...
  void ESTDPConnectionHom::set_status(const DictionaryDatum & d, nest::ConnectorModel &cm)
  {
	...
	//throw BadParameter();
	throw nest::ChangeCommonPropsByIndividual("ESTDPConnectionHom::set_status(): you are trying to set common properties via an individual synapse.");
      }
   ...
   */  
  void ESTDPConnectionHom::set_status(const DictionaryDatum & d, nest::index p, nest::ConnectorModel &cm)
  {
  ...
  void ESTDPConnectionHom::initialize_property_arrays(DictionaryDatum & d) const
  {
   ...
   */
  void ESTDPConnectionHom::append_properties(DictionaryDatum & d) const
  {
