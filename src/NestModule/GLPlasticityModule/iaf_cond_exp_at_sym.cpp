...
nest::RecordablesMap<mynest::iaf_cond_exp_at_sym> mynest::iaf_cond_exp_at_sym::recordablesMap_;
...
namespace nest  // template specialization must be placed in namespace
{
  ...
  template <>
  void RecordablesMap<mynest::iaf_cond_exp_at_sym>::create()
  {
    // use standard names whereever you can for consistency!
    insert_(names::V_m,
	    &mynest::iaf_cond_exp_at_sym::get_y_elem_<mynest::iaf_cond_exp_at_sym::State_::V_M>);
    insert_(names::g_ex,
	    &mynest::iaf_cond_exp_at_sym::get_y_elem_<mynest::iaf_cond_exp_at_sym::State_::G_EXC>);
    insert_(names::g_in,
	    &mynest::iaf_cond_exp_at_sym::get_y_elem_<mynest::iaf_cond_exp_at_sym::State_::G_INH>);
    insert_(names::V_th,
    	    &mynest::iaf_cond_exp_at_sym::get_y_elem_<mynest::iaf_cond_exp_at_sym::State_::V_TH>);
  }
}

extern "C"
inline int mynest::iaf_cond_exp_at_sym_dynamics(double, const double y[], double f[], void* pnode)
{ 
  // a shorthand
  typedef mynest::iaf_cond_exp_at_sym::State_ S;

  // get access to node so we can almost work as in a member function
  assert(pnode);
  const mynest::iaf_cond_exp_at_sym& node =  *(reinterpret_cast<mynest::iaf_cond_exp_at_sym*>(pnode));
...
mynest::iaf_cond_exp_at_sym::Parameters_::Parameters_()
  : V_th_      (-55.0    ),  // mV
    V_reset_   (-60.0    ),  // mV
    t_ref_     (  2.0    ),  // ms
    th_C       (  0.05   ),  // mV
...
mynest::iaf_cond_exp_at_sym::State_::State_(const Parameters_& p)
  : r_(0)
{
  y_[V_M] = p.E_L;
  y_[G_EXC] = y_[G_INH] = 0;
...
mynest::iaf_cond_exp_at_sym::State_::State_(const State_& s)
  : r_(s.r_)
{
...
mynest::iaf_cond_exp_at_sym::State_& mynest::iaf_cond_exp_at_sym::State_::operator=(const State_& s)
{
...
void mynest::iaf_cond_exp_at_sym::Parameters_::get(DictionaryDatum &d) const
{
...
void mynest::iaf_cond_exp_at_sym::Parameters_::set(const DictionaryDatum& d)
{
...
void mynest::iaf_cond_exp_at_sym::State_::get(DictionaryDatum &d) const
{
  def<double>(d, nest::names::V_m, y_[V_M]); // Membrane potential
  def<double>(d, nest::names::V_th, y_[V_TH]);
}

void mynest::iaf_cond_exp_at_sym::State_::set(const DictionaryDatum& d, const Parameters_&)
{
  updateValue<double>(d, nest::names::V_m, y_[V_M]);
  updateValue<double>(d, nest::names::V_th, y_[V_TH]);
}

mynest::iaf_cond_exp_at_sym::Buffers_::Buffers_(mynest::iaf_cond_exp_at_sym& n)
  : logger_(n),
    s_(0),
    c_(0),
    e_(0)
...
mynest::iaf_cond_exp_at_sym::Buffers_::Buffers_(const Buffers_&, iaf_cond_exp_at_sym& n)
  : logger_(n),
    s_(0),
    c_(0),
    e_(0)
...
mynest::iaf_cond_exp_at_sym::iaf_cond_exp_at_sym()
...
mynest::iaf_cond_exp_at_sym::iaf_cond_exp_at_sym(const iaf_cond_exp_at_sym& n)
...
void mynest::iaf_cond_exp_at_sym::init_state_(const Node& proto)
{
  const iaf_cond_exp_at_sym& pr = downcast<iaf_cond_exp_at_sym>(proto);
  S_ = pr.S_;
}

void mynest::iaf_cond_exp_at_sym::init_buffers_()
{
  ...
  B_.sys_.function  = iaf_cond_exp_at_sym_dynamics;
...
void mynest::iaf_cond_exp_at_sym::calibrate()
{
...
void mynest::iaf_cond_exp_at_sym::update(nest::Time const & origin, const nest::long_t from, const nest::long_t to)
{
...
void mynest::iaf_cond_exp_at_sym::handle(nest::SpikeEvent & e)
{
...
void mynest::iaf_cond_exp_at_sym::handle(nest::CurrentEvent& e)
{
  assert(e.get_delay() > 0);
...
void mynest::iaf_cond_exp_at_sym::handle(nest::DataLoggingRequest& e)
{
  B_.logger_.handle(e);
}
